                    ...
                    <div className="col-md-5 col-lg-4 order-md-last">
                        ...
                        <ul className="list-group mb-3">
                            {cartItems.map((item) => (
                                <li className="list-group-item d-flex justify-content-between lh-sm">
                                    ...
                                    <span className="text-body-secondary">
                                        LKR{item.price * quantities[item.id]}
                                    </span>
                                </li>
                            ))}
                            <li className="list-group-item d-flex justify-content-between">
                                ...
                                <span className="text-body-secondary">
                                    LKR{subtotal === 0 ? 0.0 : shipping.toFixed(2)}
                                </span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between">
                                <div>
                                ...
                                <span className="text-body-secondary">LKR{tax.toFixed(2)}</span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between">
                                <span>Total (LKR)</span>
                        ...
                        <form className="needs-validation" noValidate>
                            <div className="row g-3">
                                ...
                                <div className="col-md-3">
                                    ...
                                    <input type="number" className="form-control" id="zip" placeholder="12345" required/>
                                </div>
                            </div>
                            <hr className="my-4"/>
                            <button
